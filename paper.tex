...
a projection of future water supply and demand at the county level
...
based on the construction of a pipeline network is ideal. We model
...
pipelines in order to minimize costs. Anticipating the possibility
of funding being less than that required to construct all recommended
...
as to the number of de-salinization plants required to meet the change
in demand.
...
supply (given no additional interference) and demand in the United
States by 2025 on a county-by-county basis. Our primary source of
data is the County-level water use data made publically available
...
water storage and water purification systems using a network flow
algorithm.
...
\hline 
Total Water Use (Bgal/day) & 398465 & 407980 & 401554 & 410465 & 413695 & 419355\tabularnewline
\hline 
\end{tabular}
