...
The dataset we obtained was in the proprietary, binary "Shapefile" format, that is used by many professional GIS systems. Luckily, there exists an open documentation of the format \cite{shapefile-gis}, which allowed us to implement our own parser to extract the locations, and shapes of the various counties. 
