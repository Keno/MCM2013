...
In light of the 2012-2013 drought season, and the possibility of potentially
more severe droughts in the future, our department has conducted an
...
of what kinds of infrastructure needs to be developed, and how significant of a problem water shortages are likely to be in the future.
...
On one hand, we predict that the overall water demand in the country will increase by several billion gallons per day. We will attempt to solve this problem of total water supply by constructing additional 
...
The obvious solution here is a means of moving water across the country, and this can be accomplished by constructing a network of pipelines.
...
This solution is still quite expensive, but given the massive cost to the economy of droughts such as the 2012-2013 drought, we contend that it will is the most cost-effective solution to the United States' water problems.
...
For the full details of our findings, please refer to our full paper,
attached below.
...
\item Second, using cluster analysis we identify areas in which the growth in water demand will be most severe and recommend specific infrastructure in these regions to balance increased demand.
...
and 2005 \cite{key-2,key-3,key-4,key-5,key-6}. Using our projected
figures, we describe a means of minimizing the expected cost of constructing
water storage and water purification systems using a network flows
algorithm.

First, we project the County-level water needs in 2025 using water
use data from the years listed, making the assumption that water use
...
This paper is primarily concerned with the construction of new water
...
\hline 
Year & 1985 & 1990 & 1995 & 2005 & 2013 (proj.) & 2025 (proj.)\tabularnewline
\hline 
Total Water Use (Mgal/day) & 398465 & 407980 & 401554 & 410465 & 413695 & 419355\tabularnewline
\hline 
\end{tabular}

Based on the average cost of de-salinization facilities noted above, it would cost \$79 billion to build enough de-salinization plants to meet this demand.


\section{Optimising Placement of Pipelines}

Our modelling of future water needs is consistent with external research
...
To do this, we implement a variant of a minimum spannning tree algorithm
...
A secondary effect of high national connectivity is decreased reliance
on groundwater. 
...
and hence will be at risk of \textbf{severe drought}. Moreover, the
...
\bibitem[1]{key-1}Cai, X., Cline, S., Rosegrant, M. (2002). Global Water
Outlook to 2025. \emph{International Food Policy Research Institute.}

\bibitem[2]{key-2}Estimated Use of Water in the United States County-Level
Data for 1985 (1955). \emph{US Geological Survey. }

\bibitem[3]{key-3}Estimated Use of Water in the United States County-Level
Data for 1990 (1990). \emph{US Geological Survey. }

\bibitem[4]{key-4}Estimated Use of Water in the United States County-Level
Data for 1995 (1995). \emph{US Geological Survey. }

\bibitem[5]{key-5}Estimated Use of Water in the United States County-Level
Data for 2000 (2000). \emph{US Geological Survey.}

\bibitem[6]{key-6}Estimated Use of Water in the United States County-Level
Data for 2005 (2005). \emph{US Geological Survey.}

\bibitem[7]{key-7}Per Capita Water Use. Retrieved February 1, 2013,
from http://www.pepps.fsu.edu/safe/pdf/sc1.pdf

\bibitem[8]{key-8}Loh, J. (n.d.). Water management: Learning from
...
\bibitem[16]{key-16}Kennedy, D., Klein, R., Clark, M. (2004) Use
...
\bibitem[17]{key-17}China's Three Gorges Dam. Retrieved February
3, 2013, from https://www.mtholyoke.edu/\textasciitilde{}vanti20m/classweb/website/environmentalimpact.html

\bibitem[18]{key-18}http://www.wunderground.com/blog/JeffMasters/article.html?entrynum=2326\end{thebibliography}
